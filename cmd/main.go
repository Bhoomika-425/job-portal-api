...
func StartApp() error {
	...
	privatePEM, err := os.ReadFile(`C:\Users\ORR Training 19\Desktop\job-portal\private.pem`)
	if err != nil {
	...
	publicPEM, err := os.ReadFile(`C:\Users\ORR Training 19\Desktop\job-portal\pubkey.pem`)
	if err != nil {
